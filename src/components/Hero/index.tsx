        ...
        <main className="lg:min-h-screen h-175 mt-10  lg:mt-0 lg:h-213.75 w-full rounded-[20.96px] lg:rounded-[39px] bg-[#121421] overflow-hidden">
          ...
          <div className="relative">
            <div className="flex justify-around md:justify-evenly lg:justify-evenly items-center w-full h-15 mt-10 font-sunflower">
              ...
              <div className="hidden md:flex lg:flex justify-evenly items-center gap-10">
            ...
            {/* Dropdown: now absolutely positioned below navbar */}
            {isMenuOpen && (
              <div className="absolute top-full left-0 w-full flex flex-col md:hidden bg-[#121421] h-[200px] justify-center px-6 py-4 gap-4 z-50">
                <h1 className="text-white text-[18px] font-light cursor-pointer hover:text-[#3CAE8C] transition-colors">
                  Compare Exchange Rates
                </h1>
                <h1 className="text-white text-[18px] font-light cursor-pointer hover:text-[#3CAE8C] transition-colors">
                  Providers
          ...
          <div className="w-full mt-30  flex items-center gap-5 lg:gap-10 ">
            ...
            <div className="-mt-50 lg:mt-0 ml-3 lg:ml-25 relative z-30">
              ...
              <h1 className="font-normal text-[12px]/[13.47px] max-w-56.25 lg:max-w-150 mt-5 lg:mt-0 lg:text-[20px] font-inter text-[#94A3B8]">
              ...
              <div className="flex flex-col lg:flex-row justify-start lg:justify-around items-center h-full">
                <div className="flex flex-col -ml-12 lg:ml-0 lg:flex-row lg:gap-18">
                  ...
                  <button
                    ...
                    className="border-3 w-11.75 h-11.75 lg:w-13.75 lg:h-13.75 rounded-full flex flex-col justify-center cursor-pointer items-center border-[#EBEBEB] bg-black text-white absolute ml-32 lg:mt-9 mt-14 lg:ml-68 z-3"
                  >
