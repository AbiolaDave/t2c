...
const Rate = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden p-4 -mt-20 ml-2 lg:ml-32 lg:mt-30 font-sans">
      ...
      <div className="overflow-hidden w-full">
        <Image
          ...
          width={100}
          height={100}
          className="absolute w-12.25 h-25.75 ml-74 lg:h-75 -mt-5 lg:w-55  lg:ml-250 lg:-mt-10 object-fill overflow-hidden z-30"
        />
      </div>
    </div>
  );
