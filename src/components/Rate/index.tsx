...
const Rate = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden p-4 -mt-64 ml-2 lg:ml-32 lg:mt-30 font-sans">
      ...
      <div className="object-fill">
        <Image
          ...
          width={100}
          height={100}
          className="absolute w-42.25 h-45.75 ml-65 lg:h-75 -mt-5 lg:w-55  lg:ml-250 lg:-mt-10 object-fill z-30"
        />
      </div>
    </div>
  );
